document.getElementById("changeURL").addEventListener("click", changeURL);
...
document.getElementById("imgdivopac").addEventListener("click", divopactest);
...
// what i want:
  // INITIALIZE
  // set the position to be 15px left and top off screen
  // set the width to be 100% + 15wide +15high

  // TRANSFORM
  // fade the image from 0 to 1 in 5 seconds
  // move the image from left to right in 5 seconds
  // change the size from 100% to 110% in 5 seconds`

  // FADE AWAY
  // fad the image from 1 to 0 in 5 seconds
